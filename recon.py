...
encoder_dalle = load_model("/data/nieshen-cx/taming-transformers/encoder.pkl", DEVICE)
decoder_dalle = load_model("/data/nieshen-cx/taming-transformers/decoder.pkl", DEVICE)
